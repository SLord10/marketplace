...
public class UserClient extends User implements Parcelable {
    ...
    public UserClient(String username, String password, String email, String postalAddress, String rib, String surname, String name, Integer sexe, String paiement, Integer nUtilisateur) {
