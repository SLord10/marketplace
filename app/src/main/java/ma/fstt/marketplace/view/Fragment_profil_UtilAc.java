...
public class Fragment_profil_UtilAc extends Fragment {
    ...
    private UserClient utilisateurAc;
    private UserClient utilisateur;
    private CutilAc cutilAc;
    public Fragment_profil_UtilAc(UserClient utilisateur){
    ...
    private void ecouteurModif(final Context context, final UserClient utilisateur) {
