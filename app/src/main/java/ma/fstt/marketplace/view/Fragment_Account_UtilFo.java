...
public class Fragment_Account_UtilFo extends Fragment {
    ...
    private UserSupplier utilFo, initUserSupplier;
    ...
    public Fragment_Account_UtilFo(UserSupplier utilisateurFo){
    ...
    private void init(View view) {
        ...
        UserSupplier utilisateur = cpageAccueil.getConnexionFO(utilFo.getUsername());
        initUserSupplier =utilFo;
    ...
    private void ecouteurModif(final UserSupplier utilisateur) {
