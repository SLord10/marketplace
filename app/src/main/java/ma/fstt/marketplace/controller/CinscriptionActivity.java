...
import ma.fstt.marketplace.model.SignUpClient;
import ma.fstt.marketplace.model.SignUpSupplier;
import ma.fstt.marketplace.tools.SqLiteAccessRequest;

public class CinscriptionActivity {

    private SignUpClient inscriptionAc;
    private SignUpSupplier inscriptionFo;
    ...
    public void getInscriptionInstanceAc(String username, String password, String email,
        ...
        inscriptionAc= new SignUpClient(username,password,email,postalAddress,surname,name,sexe,rib);
    ...
    public void getInscriptionInstanceFo(String username, String password, String email,
        ...
        inscriptionFo= new SignUpSupplier(username,password,email,postalAddress,rib, raisonSociale);
