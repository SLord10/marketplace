...
public class SqLiteAccessRequest extends SQLiteOpenHelper {
     ...
     */
    public UserClient connexionAC(String username){
        UserClient utilisateur;
        ...
        while(!(cursor.isAfterLast())){
            ...
            utilisateur = new UserClient(cursor.getString(0), cursor.getString(1),
     ...
     */
    public UserSupplier connexionFo(String username){

        // Création d'une variable de type UtilisateurFo
        UserSupplier utilisateur;
        ...
        while(!(cursor.isAfterLast())){
            ...
            utilisateur = new UserSupplier(cursor.getInt(0), cursor.getString(1), cursor.getString(2),
